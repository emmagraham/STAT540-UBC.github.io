...
```{r include=FALSE}
library(RCurl)
URL = getURL( "https://raw.githubusercontent.com/STAT540-UBC/STAT540-UBC.github.io/master/examples/photoRec/data/GSE4051_data.tsv" )
...
```
```{r include=FALSE}
URL = getURL( "https://raw.githubusercontent.com/STAT540-UBC/STAT540-UBC.github.io/master/examples/photoRec/data/GSE4051_design.tsv" )
...
```
```{r include=FALSE}
URL = getURL("https://raw.githubusercontent.com/STAT540-UBC/STAT540-UBC.github.io/master/examples/photoRec/data/GSE4051_MINI.tsv")
